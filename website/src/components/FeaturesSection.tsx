    ...
    },
    {
      ...
      icon: (
        <svg width="12" height="12" viewBox="0 0 16 16" fill="none">
          ...
          <path
            d="M13.5,8 A5.5,5.5 0 0,1 8,13.5 L8,8 Z"
            fill="currentColor"
            fillOpacity="0.7"
          />
          <path
            d="M8,13.5 A5.5,5.5 0 0,1 2.5,8 L8,8 Z"
            fill="currentColor"
            fillOpacity="0.4"
          />
          <path
            d="M2.5,8 A5.5,5.5 0 0,1 8,2.5 L8,8 Z"
            fill="currentColor"
            fillOpacity="0.7"
          />
        </svg>
    ...
    },
    {
      ...
      icon: (
        <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor">
          <path
            d="M2,14 L2,10.5 L4.5,7 L7,8.5 L9.5,5.5 L12,6.5 L14,4 L14,14 Z"
            fillOpacity="0.7"
          />
          <path
            d="M2,10.5 L4.5,7 L7,8.5 L9.5,5.5 L12,6.5 L14,4"
            fill="none"
            stroke="currentColor"
            strokeWidth="1"
          />
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          <polygon
            points="8,4 10.8,6.2 9.8,9.8 6.2,9.8 5.2,6.2"
            fill="currentColor"
            fillOpacity="0.5"
          />
        ...
        {snapshots.map((snapshot, index) => (
          <div key={index} className="flex items-center gap-2">
            ...
            <div className="flex-shrink-0 w-20 h-6 bg-gray-100 border border-gray-300 rounded text-xs text-gray-700 flex items-center justify-center font-medium px-2 gap-1">
              <span className="text-gray-600">{snapshot.icon}</span>
  ...
  const features = [
    {
      ...
      title: "圖表匯出",
      description:
        "支援多種格式匯出，包括 PNG、SVG 等格式，方便在簡報或文件中使用。",
    ...
    },
    {
      ...
      title: "分享與嵌入功能",
      description:
        "一鍵生成分享連結，支援 iframe 嵌入，讓圖表輕鬆整合到任何網站或平台。",
    ...
    },
    {
      ...
      title: "多種圖表類型",
      description:
        "支援長條圖、圓餅圖、折線圖等多種視覺化圖表格式，滿足不同數據展示需求。",
    ...
    },
    {
      ...
      title: "表格檢視",
      description:
        "除了圖表外，也提供原始資料的表格檢視模式，讓數據查看更加靈活。",
    ...
    },
    {
      ...
      title: "快照系統",
      description:
        "自動保存資料快照，確保歷史數據的完整性，並支援時間點比較分析。",
      ...
      <div className="container">
        ...
        >
          ...
          <motion.div
            ...
            className="md:col-start-1 md:row-start-1 md:row-span-1"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="md:col-start-3 md:row-start-1 md:row-span-1"
          >
            <Card className="h-full group transition-all duration-300 hover:-translate-y-1 border border-gray-200 hover:border-black hover:border-2 shadow-none hover:shadow-lg bg-white">
              <CardHeader className="text-center pb-2">
                <div className="mx-auto mb-2 relative">
          ...
          <motion.div
            variants={itemVariants}
            className="md:col-start-2 md:row-start-3 md:row-span-1"
          >
            <Card className="h-full group transition-all duration-300 hover:-translate-y-1 border border-gray-200 hover:border-black hover:border-2 shadow-none hover:shadow-lg bg-white">
              <CardHeader className="text-center pb-2">
                <div className="mx-auto mb-2 relative">
            ...
            <div className="relative w-full md:w-1/2 h-[250px] md:h-[300px] overflow-hidden">
              ...
              >
                ...
                <defs>
                  ...
                  <radialGradient
                    ...
                    r="1"
                    gradientUnits="userSpaceOnUse"
                    gradientTransform="translate(63.4043 306.574) rotate(-132.571) scale(103.192 103.372)"
                  >
                    <stop stopColor="white" />
                    <stop offset="1" stopColor="white" stopOpacity="0" />
                  </radialGradient>
                  <radialGradient
                    id="whiteStrokeRadial"
                    cx="0"
                    cy="0"
                    r="1"
                    gradientUnits="userSpaceOnUse"
                    gradientTransform="translate(35.3475 279.408) rotate(-113.962) scale(61.4062 126.439)"
                  >
                    <stop stopColor="white" />
                    <stop offset="1" stopColor="white" stopOpacity="0" />
                  </radialGradient>
                ...
                <g
                  transform="translate(-200, -700) scale(4, 3.5)"
                  clipPath="url(#completeSphereClip)"
                >
                  {/* 遮罩組 - 包含完整的球體線框 */}
                  ...
                  {/* 原始SVG的精確連線路徑 - 細線條白色 */}
                  <path
                    d="M163.815 289.173C168.96 287.532 182.524 283.584 195.618 280.922"
                    stroke="url(#whiteConn1)"
                    strokeWidth="1"
                    opacity="1"
                  >
                    <animate
                      attributeName="stroke-dasharray"
                      values="0,15;7,7;0,15"
                      dur="3s"
                  ...
                  <path
                    opacity="0.7"
                    d="M163.743 289.032C145.537 294.219 120.666 304.679 101.45 315.562C98.5928 309.936 92.5914 296.549 91.4453 288.014"
                    stroke="url(#whiteConn2)"
                    strokeWidth="1"
                  >
                    <animate
                      attributeName="stroke-dasharray"
                      values="0,18;9,9;0,18"
                      dur="2.5s"
                      repeatCount="indefinite"
                    />
                    <animate
                  ...
                  <path
                    opacity="0.7"
                    d="M131.988 300.584C109.209 309.463 67.2367 334.448 46.0713 353.25"
                    stroke="url(#whiteConn3)"
                    strokeWidth="1"
                  >
                    <animate
                      attributeName="stroke-dasharray"
                  ...
                  <path
                    d="M163.45 288.852C160.552 283.745 155.015 270.79 156.05 259.82C157.085 248.849 161.432 243.106 162.726 241.501C143.941 238.551 103.163 236.947 70.9746 248.642"
                    stroke="url(#whiteConn4)"
                    strokeWidth="1"
                    opacity="1"
                  >
                    <animate
                  ...
                  <path
                    d="M107 416.714C113.591 406.473 136.106 381.182 146.594 369.603C136.483 361.56 125 348.684 120.428 343.179C136.916 330.022 164.082 313.53 175.604 306.929C172.568 303.3 166.025 294.617 163.637 289.305"
                    stroke="url(#whiteConn5)"
                    strokeWidth="1"
                    opacity="1"
                  >
                    <animate
                      attributeName="stroke-dasharray"
                      values="0,24;12,12;0,24"
                      dur="3.5s"
                      repeatCount="indefinite"
                    />
                    <animate
                  ...
                  <path
                    d="M208.664 423.039C215.773 410.086 229.419 369.035 235.78 350.283C207.668 338.623 187.65 321.055 175.596 306.866"
                    stroke="url(#whiteConn6)"
                    strokeWidth="1"
                    opacity="1"
                  >
                    <animate
                  ...
                  <path
                    d="M285.525 394.502C259.949 393.085 234.914 384.28 225.594 380.056C228.046 373.322 233.523 357.947 235.811 350.32"
                    stroke="url(#whiteConn7)"
                    strokeWidth="1"
                    opacity="1"
                  >
                    <animate
              ...
              <div className="absolute inset-0 pointer-events-none">
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(ellipse at center, transparent 0%, transparent 60%, rgba(0,0,0,0.3) 90%, rgba(0,0,0,1) 100%)",
                  }}
                ></div>
                {/* 四邊線性漸層遮罩 */}
                <div
